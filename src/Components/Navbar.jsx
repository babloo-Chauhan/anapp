...
const Navbar = React.memo(function Navbar({ onLeftClick }) {
    ...
    const toggleLayout = () => {
        setIsOpen(!isOpen);
        onLeftClick(false); // Call the function passed from Card component to toggle sidebar
    ...
    return (
        <div className='fixed left-0 top-0 flex h-16 w-full items-center justify-between bg-amber-900 px-4 z-50'>
